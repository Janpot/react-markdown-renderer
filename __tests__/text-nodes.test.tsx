...
describe("Text Node Handling", () => {
  it("groups adjacent text and inline elements in top-level Document", () => {
    const markdown = render(
      <Document>
        This is a text node followed by{" "}
        <Strong>bold text</Strong> and more plain text with{" "}
        <Emphasis>emphasized text</Emphasis> all in one paragraph.
      </Document>
    );
  ...
  it("properly handles text with whitespace", () => {
    const markdown = render(
      <Document>
        ...
        and line breaks should be
        preserved in a reasonable way.
      </Document>
    );
